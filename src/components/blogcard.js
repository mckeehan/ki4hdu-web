  ...
  return (
                        <div className="col-lg-4 mb-5">
                            <div className="card h-100 shadow border-0">
                                {blog.frontmatter.featuredImage && <img className="card-img-top" src={blog.frontmatter.featuredImage} alt="" />}
                                    ...
                                    <div className="d-flex align-items-end justify-content-between">
                                        { blog.frontmatter.author && (
                                          <div className="d-flex align-items-center">
                                              <img className="rounded-circle me-3" width="40" height="40" src={blog.frontmatter.author.avatar} alt={blog.frontmatter.author.name}/>
                                              <div className="small">
